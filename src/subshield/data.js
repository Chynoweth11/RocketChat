/**
 * Initial seed data for SubShield.
 *
 * Product model: "Rocket Money for business insurance." The data is structured
 * like a production model (carriers, premiums, deductibles, renewal dates,
 * alternate quotes, documents) while persisting locally for this frontend-only
 * repository.
 */
...
export const initialData = {
  ...
  documents: [
    ...
    },
    {
      ...
      name: "Turner Project Insurance Requirements",
      docType: "endorsement",
      policyId: null,
      policyType: null,
      carrier: "Turner Construction",
      fileType: "PDF",
      sizeKb: 64,
      status: "verified",
      addedBy: "Jordan Rivera",
  ...
  settings: {
    ...
    roles: [
      {
        id: "role-owner",
        name: "Owner",
        description: "Full account, subscription, and workspace control",
        permissions: {
          vault: true,
          sendCoi: true,
          manageSettings: true,
    ...
    subscription: {
      ...
      autoRenew: true,
      adminEmail: "admin@subshieldtile.com",
    },
    documentPreferences: {
