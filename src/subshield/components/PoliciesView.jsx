  ...
  return (
    <div className="ss-grid">
      <section className="ss-card ss-span">
        <div className="ss-policy-command">
          <div className="ss-policy-command-copy">
            <span className="ss-eyebrow">
              {critical.length ? "Action needed" : "Coverage healthy"}
            </span>
            <h2>Portfolio command desk</h2>
            <p>
              {policies.length} tracked policies with premium, deductible, renewal,
              document, and certificate readiness organized in one operating view.
            </p>
            <div className="ss-policy-command-actions">
          ...
          <div className="ss-policy-command-side">
            <ScoreRing value={score} />
            <div className="ss-policy-assurance">
              <ShieldCheck size={15} />
              <span>Carrier documents and renewal details are ready for executive review.</span>
            </div>
          </div>
        </div>
